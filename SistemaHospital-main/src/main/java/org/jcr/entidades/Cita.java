...
//LOMBOK, se quitaron los getters manuales. No se saco nada mas,  el constructor, setters, toString, toCsvString y fromCsvString se mantienen idénticos.
...
@Getter  // Genera automáticamente todos los getters simples para los campos (paciente, medico, sala, fechaHora, costo, estado, observaciones)
