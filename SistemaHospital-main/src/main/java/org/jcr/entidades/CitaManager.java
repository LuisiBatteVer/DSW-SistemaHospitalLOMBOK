...
//No hay código repetitivo que Lombok pueda reducir (no hay getters/setters para campos; los métodos son lógica de negocio única). Los campos son final y privados, sin necesidad de accesores.
import java.io.*;
