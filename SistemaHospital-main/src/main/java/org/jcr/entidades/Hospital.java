...
@Getter  // Genera automáticamente los getters simples para los campos final: getNombre(), getDireccion(), getTelefono()
public class Hospital implements Serializable {
    ...
    // Getters internos (package-private) para uso en relaciones bidireccionales
